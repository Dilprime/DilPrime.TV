function login() {
    ...
    if (username == 'Venom'){
        todolist.innerHTML = '<li class="mdl-list__item mdl-list__item--two-line"> <span class="mdl-list__item-primary-content"> <i class="material-icons mdl-list__item-avatar">person</i> <span>DilPrime</span> <span class="mdl-list__item-sub-title">Venom: Let There Be Carnage</span> </span> <span class="mdl-list__item-secondary-content"> <span class="mdl-list__item-secondary-info"></span> <a class="mdl-list__item-secondary-action" href="#"> <span class="material-icons">check_circle</span></a></li>' + '<video src="https://e1xd1c9b884-6b67-4bc4-8b38-7fe101682ea8.hdfilme.ws/4afb1007bff42bc4160818bbd9a78192/1657207734971/1d/73/e219aad4869c0d5670d2921356e1731d14dd75ddf0b4bfb48b1e47b2a/e219aad4869c0d5670d2921356e1731d820b09bb9acbfde9c35c71e0e565dad8_1080p.mp4" type="mp4/video"  width="375px" autoplay="autoplay" controls="controls"></video>';
};
